...
export default function StaffManagement() {
  ...
  const createStaffAccount = async (e) => {
    ...
    try {
      ...
      // ✅ set displayName so it appears in list
    ...
    if (result.isConfirmed) {
      try {
        ...
        if (res.ok) {
          ...
          Swal.fire(
            "মুছে ফেলা হয়েছে!",
            "স্টাফ অ্যাকাউন্ট মুছে ফেলা হয়েছে।",
            "success"
          );
        } else {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="bg-blue-500 text-white px-6 py-3 rounded-xl font-semibold hover:bg-blue-600 transition-all duration-300 shadow-lg"
            >
