  ...
  return (
    ...
    >
      ...
      <div
        ...
        )} mb-6 mt-20 rounded-3xl shadow-2xl overflow-hidden transform hover:scale-[1.02] transition-all duration-500 cursor-pointer`}
                  ...
                  <div className="flex-1">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 sm:gap-2 mb-2 sm:mb-3">
                      ...
                      <div className="flex items-center space-x-1 sm:space-x-2 text-white/80 text-xs sm:text-sm">
                        ...
                        <span>
                          {new Date(currentNotice.date).toLocaleDateString(
                            "bn-BD"
                          )}
                        </span>
                      </div>
                    </div>
                    <p className="text-white/90 leading-relaxed text-sm sm:text-base mb-2 sm:mb-4">
                  ...
                  .map((notice) => {
                    ...
                    return (
                      <motion.div
                        ...
                        onClick={() =>
                          goToNotice(
                            notices.findIndex((n) => n._id === notice._id)
                          )
                        }
                      ...
                      >
                        <div className="flex items-center space-x-2 sm:space-x-3">
                          ...
                          <span className="text-white font-medium text-xs sm:text-sm line-clamp-2">
                            {notice.title}
                          </span>
                        </div>
                      </motion.div>
