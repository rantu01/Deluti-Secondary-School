    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="text-center">
          ...
          <h3 className="text-xl font-semibold text-gray-700 mb-2">প্রক্রিয়া চলছে...</h3>
  ...
  if (user) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-teal-100">
        <div className="bg-white p-8 rounded-2xl shadow-2xl max-w-md w-full mx-4 border border-green-200">
          <div className="text-center">
      ...
      <div className="bg-white p-8 rounded-3xl shadow-2xl w-full mx-4 border border-blue-100">
        ...
        <div className="text-center mt-6 pt-6 border-t border-gray-200">
          <p className="text-gray-600">
            ...
            >
              {isLogin ? 'এখানে ক্লিক করে রেজিস্টার করুন' : 'এখানে ক্লিক করে লগইন করুন'}
            </button>
          </p>
        </div>
